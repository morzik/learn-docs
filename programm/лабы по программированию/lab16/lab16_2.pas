...
{---------------------------------------------------------}
procedure maxlength(n:integer;h:A);
var i:integer; im:st;
begin
im:=X[1].pas.ad.street;
for i:=2 to n do
if length(im)>length(h[i].pas.ad.street)
then im:= h[i].pas.ad.street;
writeln ('Самое длинное название улицы = ',im);
end;
