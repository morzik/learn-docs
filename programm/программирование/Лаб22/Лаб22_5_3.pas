...
for i:=1 to n do
    begin
         for j:=i to n do
             if (h[i].yo div 100) + 1=(h[j].yo div 100) + 1 then inc(q);
         if qB<q then
            begin
               qB:=q;
               q:=0;
...
for i:=1 to n do
    begin
    for j:=i to n do if (h[i].yo div 100) + 1=(h[j].yo div 100) + 1 then inc(q);
        if q=qB then
           for j:=i to n do
               if (h[i].yo div 100) + 1=(h[j].yo div 100) + 1 then
          begin
          w[c]:=h[j];  inc(c);
          end;
        q:=0;
